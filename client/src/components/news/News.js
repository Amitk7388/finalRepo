...
class News extends Component {
	...
	render() {
        ...
        <div class="card-body">
        <h5 class="card-title">Stealth Soincs gets featured in an interview during the Hong Kong Av Show - 2018 </h5><br/>
        <a href="https://m.facebook.com/lyramedia/photos/a.133422710080161/1925101210912293/?type=3&source=48" class="btn btn-primary">Read More</a>
        </div>
        </div>
        </div>
        ...
        <a href="https://www.facebook.com/116775131744919/posts/1889257281163353/" class="btn btn-primary">Read More</a>
        </div>
        </div>
        </div>
