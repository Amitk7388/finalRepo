                                ...
                                <div className="col-md-12">  
                                    <div className="changeBg changeLogo mt10 mb10">
                                        <h5>Logo</h5>
                                            ...
                                            <input type="text" id="inputBox" className="form-control mt10" maxLength="5" name="" 
                                            placeholder=" Maximum 5 letters" disabled/>
                                            </div>
                        ...
                        <section>
                            <div className="row">
                                <div className="col-md-12">  
                                 ...
                                 <span className="name-span">Artist Relations</span><br/>
                                     <address>
                            ...
                            +1 615 523 9995</address>
                                 ...
                                 <label>
                                  ...
                                  <div className="color-black address-color"> 
                                  <span className="name-span">Labkable</span>
                                     <address>
