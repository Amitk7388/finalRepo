...
class CustomOrder extends Component {
    constructor(props) {
        ...
        this.state={
            ...
            rightUploadedText:"",
            leftUploadedText:"",
            defaultLeftLogo : "translate(-200px,40px)",
            defaultRightLogo : "translate(-195px,40px)",
            leftImageVisibility:"visible",
            rightImageVisibility:"visible",
            activeBoth: "active"
        }
                    ...
                    <section>
                        <div className="col-md-6">
                            <div className="row">            
                                ...
                                <img className="responsive" style={{display:"", width:"249px", height:"326px", marginLeft:"-450px", marginTop:"0px", paddingLeft:"-60px", position: 'absolute', transform: "rotate(4deg)"}} id="adel-mask-preload-left"  src={this.state.leftShell} />

                                    <span id="leftUploadedTextID" style={{fontSize: "22px", marginTop:"-135px", marginLeft: "160px", zIndex: 1, color: this.state.leftCaseColor}}>{this.state.leftUploadedText}</span>

                                {this.state.leftUploadedImage ==="" ? <img className="responsive logoooo" style={{width:"86px", paddingRight:"-62px", marginLeft:"-191px", marginTop:"0px", zIndex: "1", borderRadius:"0", position: 'relative', display: '-webkit-inline-box',transform:this.state.defaultLeftLogo}} id="adel-mask-preload-left"  src={this.state.defaultLogoLeft}/>
                                :
                                <img className="responsive" style={{width:"86px", height:"86px", paddingRight:"-62px", marginLeft:"-191px", marginTop:"0px", zIndex: "1", borderRadius:"0", position: 'relative',visibility:this.state.leftImageVisibility, transform: 'translate(-200px,40px)'}} id="adel-mask-preload-left"  src={this.state.leftUploadedImage}/>
                                
                                 }
                                <img className="responsive mainImg" style={{width:"202px", height:"329px", marginTop:"2px", zIndex:"-1px", marginLeft:"-327.5px", position: 'absolute'}} id="adel-mask-preload-left"  src={this.state.left} />

                                <img className="responsive" style={{ width:"211px", height:"341px", marginLeft:"-130px", marginTop:"0px", position: 'absolute'}} id="adel-mask-preload-left"  src={this.state.rightShell}/>
                                       
                                    <span id="rightUploadedTextID" style={{fontSize: "22px", marginTop:"-135px", marginLeft: "390px", zIndex: 1, color: this.state.rightCaseColor}}>{this.state.rightUploadedText}</span>

                                <img className="responsive" style={{width:"202px", height:"327px", marginLeft:"-127px", position: 'absolute', marginTop:"7px"}} id="adel-mask-preload-left"  src={this.state.right}/>
                                {this.state.rightUploadedImage ==="" ?

                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"0px", zIndex: "1", borderRadius:"0", position: 'relative', display: '-webkit-inline-box',transform: 'translate(75px, 50px)'}}  src={this.state.defaultLogoRight}/>
                                :
                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", visibility:this.state.rightImageVisibility ,marginLeft:"-121px", marginTop:"0px", zIndex: "1", borderRadius:"0", position: 'relative',height:"86px", transform: 'translate(80px, 50px)'}}  src={this.state.rightUploadedImage}/>
                                }
                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"-356px", zIndex: "1", borderRadius:"0", position: 'initial'}}  src={this.state.uploadrightLogo}/>

                                <img className="responsive" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"-356px", zIndex: "1", borderRadius:"0", position: 'initial'}}  src={this.state.uploadrightLogo2}/>
                                </div>
                        ...
                        <div className="item-specifications">
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <label>Modal Name : <span>C2</span></label>
